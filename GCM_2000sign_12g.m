...
frameMode = 'allFrame';
nSample = 12;
nInsert = 10;           % is the nFrame less than nInsert, enlarge it. 
nClass = length(names);
%% Readin the data
% % Readin the data from original txt files.
% routePath = 'D:\iCode\SignLanKinectCode\ftdcgrs_publishData_whj\output\dim334_CTskp_allFrame_2000sign_12group_v3\';
% 
% % The data path
...
%     end
% end
% save('dim334sub10_CTskp_allFrame_2000sign_12group.mat','D');
...
fprintf(fid,'Training time (2000sign_8g): %f\n',trainTime);
fprintf(fid,'Test time (2000sign_4g): %f\n',testTime);
fclose(fid);